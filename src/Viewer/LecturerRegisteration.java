...
public class LecturerRegisteration extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(lbl_TreatmentCardNumber, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 320, -1, -1));
        ...
        getContentPane().add(txt_userName, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 320, -1, -1));
        ...
        getContentPane().add(lbl_fileNumber, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 380, -1, -1));
        ...
        getContentPane().add(lbl_birthday, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 500, -1, -1));
        ...
        getContentPane().add(lbl_fileNumber1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 440, -1, -1));
        ...
        getContentPane().add(txt_phone, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 440, -1, -1));
        ...
        getContentPane().add(txt_address, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 500, -1, -1));
        ...
        getContentPane().add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 380, -1, -1));
        ...
        getContentPane().add(box_showPass, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 380, -1, 35));
    ...
    private void btn_saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_saveActionPerformed
        try {
            if (!(txt_address.getText().equals("") || txt_Id.getText().equals("")
                ...
                String sql1 = "Select id from lecturer where id= '" + txt_Id.getText() + "'";
                rs = stmt.executeQuery(sql1);
                if (rs.next()) {
                    JOptionPane.showMessageDialog(this, "User ID is already exists,choose another one!!", "Error", JOptionPane.ERROR_MESSAGE);

                } else {
                    String sql = "insert into lecturer(id,name,phone,address,email,password)"
                    ...
                    prs.execute();
                    JOptionPane.showMessageDialog(this, "Successfully saved", "Added Lecturer", JOptionPane.INFORMATION_MESSAGE);
                    rs.close();
                    prs.close();
                }
            } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LecturerRegisteration.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LecturerRegisteration().setVisible(true);
            }
        });
    }
